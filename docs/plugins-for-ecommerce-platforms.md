...
1. Click on [this link](https://drive.google.com/uc?export=download&id=1wWPXhMZdo-TqcgJjxr2bs7sejg3INMcW) to download Klix PrestaShop plugin in case your store Prestshop version is 1.7.6. or newer. If you use Prestashop version that's older than 1.7.6. then click on [this link](https://portal.klix.app/ecommerce_modules/prestashop-v1.7+.zip) (note that translations functionality will work only with Prestashop 1.7.6. and newer version).
...
1. Click on [this link](https://drive.google.com/uc?export=download&id=1OGSzs-x5tPVCL3httZQTbLMlxyrXaG6i) to download Klix WooCommerce plugin.
